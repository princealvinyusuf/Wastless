...
extension Challenge {
    static func createChallenge() -> [Challenge] {
        return [
            ...
            Challenge(
                title: "Use Metal Straw",
                image: "metalStraw",
                point: 70,
                challengeDetail: "One way to help reduce the effect that plastic is having on the environment is to forego a plastic straw and use a metal one instead. here are some key reason :\n \n1. Safe and Durable \n2. Easy to clean \n3. Portable and Reusable \n4. Eco-Friendly \n5. Decreasing the needs for landfill",
                level: .novice),
            
            Challenge(
                title: "Use Shopping Bag",
                image: "shoppingBag",
                point: 100,
                challengeDetail: "Rather than collecting an abundance of single use plastic bags that are not only inconvenient, but harmful to the environment and costly, try using a reusable shopping bag. There are plenty of benefits to investing a reusable bag :\n \n1. Save Resources and therefore, Money! \n2. More durable and reliable \n3.  Less Plastics in Landfills \n4. De-clutter your house and save space \n5. Because you can do it to save environment!",
                level: .ecoStarter),
