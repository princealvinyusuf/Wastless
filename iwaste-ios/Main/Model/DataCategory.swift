...
let catPlastic = ModelWaste(categoryName: "Plastic", categoryImg: UIImage(named: "inputPlastic")!, waste: [straw, bottle, snackPackage, drinkCup, plasticBag])
...
let catGlass = ModelWaste(categoryName: "Glass", categoryImg: UIImage(named: "inputGlass")!, waste: [jar, glassCup, ceramicCup, glassBottle, plate])
...
let catPaper = ModelWaste(categoryName: "Paper", categoryImg: UIImage(named: "inputPaper")!, waste: [foodBox, hardBox, softBox, paperDrinkCup, papers])
...
let catMetal = ModelWaste(categoryName: "Metal", categoryImg: UIImage(named: "inputMetal")!, waste: [foodCans, beverageCans, screwUtensils, battery, sprayCan])
...
let catOrganic = ModelWaste(categoryName: "Organic", categoryImg: UIImage(named: "inputOrganic")!, waste: [leftovers, cigarette, leaves, eggshell, rindWeevils])
